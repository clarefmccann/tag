...
w5s1 <- w4s1[, c(1, 3)]
w5s1$lapse_predicted <- runif(83, 14, 18) 
w5s2 <- w5s1[, c(1,2,3)]
...
w6s1 <- w5s1[, c(1, 2)]
w6s2 <- w5s2[, c(1, 2)]
w6s1$lapse_predicted <- runif(83, 7, 9) 
...
w5s1_predicted$lapse_predicted <- runif(59, 14, 16) 
...
w6s1_predicted$w6s1_lapse_predicted <- runif(59, 7, 12)
